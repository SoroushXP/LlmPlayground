...
/// </summary>
public record LmStudioConfiguration
{
    /// <summary>
...
/// </summary>
public sealed class LmStudioProvider : ILlmProvider, IModelListingProvider
{
    ...
    public LmStudioProvider(LmStudioConfiguration configuration)
    {
    ...
    /// <inheritdoc />
    public string ProviderName => $"LM Studio ({_configuration.Model})";
    ...
    public Task InitializeAsync(CancellationToken cancellationToken = default)
    {
        ...
        // LM Studio doesn't require an API key, but the client needs one
